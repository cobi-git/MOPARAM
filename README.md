...
Compiled data (CDA): 
A CDA is a two dimensional (sample x omics) matrix. 
The size of the a CDA will differ across projects and cancer types, due to the differing number of samples, genes and available omics types. 
...
Here is the code for exec_all_test.py. If you execute this code, you can perform all test codes sequentially.
